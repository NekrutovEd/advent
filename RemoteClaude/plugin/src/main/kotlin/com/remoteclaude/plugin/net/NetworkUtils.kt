...
object NetworkUtils {
    ...
    private val LOG = Logger.getInstance(NetworkUtils::class.java)
    ...
    fun getLocalAddress(): Inet4Address? {
        ...
        if (candidate != null) {
            ...
            LOG.info("RemoteClaude net: candidate $candidate rejected (iface=${iface?.displayName}), scanning interfaces")
        }
